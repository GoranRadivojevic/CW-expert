...
namespace CWExpert
{
    public static class DB
    {
        ...
        private static void AddBandLimitsTable()
        {
        ...
        private static void AddG59BandFiltersTable()
        {
        ...
        private static void AddG11BandFiltersTable()
        {
            ...
            object[] data = {
                                ...
                                5.280001, 7.999999, Band.B40M.ToString(),
        ...
        private static void AddLOGTable()
        {
            ...
            {                
                ...
                QSOTable.Columns.Add("MyNR", typeof(string));
                QSOTable.Columns.Add("NR", typeof(string));
